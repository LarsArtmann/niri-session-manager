...
| Verify terminal restore flags against real CLIs (wezterm `start --cwd`, ghostty `-e`, foot/kitty/alacritty)                                 | 🔴 `TODO` | Medium | Low    | `src/main.rs:432` `build_terminal_restore_command`; unit tests assert what code _builds_, not what terminals _accept_ |
...
_Harvested 2026-09-03 from `docs/status/2026-09-03_00-00_bug-review-and-agents-md.md` and `docs/status/2026-07-03_10-38_reliability-hardening-and-v0.3.0.md` (now archived under `docs/status/archived/`). Every item verified against code on this date._
